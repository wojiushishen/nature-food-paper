...
y_test_tf=tf.concat([y_species_test, y_temperature_test, y_time_test], 1)
#y_test_tf=tf.concat([y_species_test, y_temperature_test, y_time_test, y_dye_test], 1)
with tf.Session()as sess:
    y_test = y_test_tf.eval()
...
y_train_tf=tf.concat([y_species_train, y_temperature_train, y_time_train], 1)
with tf.Session()as sess:
